        ...
        http
            ...
            .headers { headers ->
                ...
                headers.contentSecurityPolicy { csp ->
                    csp.policyDirectives("default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://cdn.quilljs.com https://unpkg.com https://cdn.sheetjs.com https://checkout.squadco.com https://js.paystack.co https://*.paystack.com https://*.paystack.co https://*.cardinalcommerce.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://cdn.quilljs.com https://fonts.googleapis.com https://paystack.com https://*.paystack.com https://*.paystack.co https://cdn.jsdelivr.net; font-src 'self' https://cdnjs.cloudflare.com https://fonts.gstatic.com; img-src 'self' data: https://*.paystack.com https://*.paystack.co; connect-src 'self' https://cdn.quilljs.com https://checkout.squadco.com https://popup.squadco.com https://checkout.paystack.com https://*.paystack.com https://*.paystack.co https://*.cardinalcommerce.com https://cdn.jsdelivr.net; frame-src 'self' https://checkout.squadco.com https://popup.squadco.com https://checkout.paystack.com https://*.paystack.com https://*.paystack.co https://*.cardinalcommerce.com; form-action 'self' https://checkout.squadco.com https://*.paystack.com https://*.paystack.co https://*.cardinalcommerce.com")
                }
