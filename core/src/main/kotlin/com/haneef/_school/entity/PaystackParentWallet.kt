...
@Entity
@Table(
    name = "paystack_parent_wallets",
    uniqueConstraints = [
        UniqueConstraint(columnNames = ["parent_id"], name = "unique_paystack_parent_wallet")
    ],
    indexes = [
        Index(columnList = "parent_id", name = "idx_paystack_wallet_parent"),
        Index(columnList = "account_number", name = "idx_paystack_wallet_account_number"),
        Index(columnList = "customer_code", name = "idx_paystack_wallet_customer_code")
    ]
)
class PaystackParentWallet(
